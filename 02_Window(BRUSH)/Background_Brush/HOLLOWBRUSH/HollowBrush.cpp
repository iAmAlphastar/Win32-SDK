...
{
	MessageBox(NULL, TEXT("You Entered WinMain..!!!"), TEXT("WinMain"), MB_OK);
	...
	{
		MessageBox(NULL, TEXT("RegisterClassEx class unsuccessfully!!!"), TEXT("RegisterClass"), MB_ICONERROR);
	}

	MessageBox(NULL, TEXT("RegisterClassEx class successfully registered..!!!"), TEXT("RegisterClass"), MB_OK);

	//create window this window is only created in memory i.e. RAM

	hwnd = CreateWindow(szAppName,
		TEXT("HOLLOWBRUSH_DEMO"),
